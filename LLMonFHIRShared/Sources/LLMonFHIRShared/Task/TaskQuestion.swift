...
public struct TaskQuestion: Hashable, Sendable {
    ...
    public init(text: String, type: TaskQuestionType, isOptional: Bool = false) {
        self.text = text
        self.type = type
    ...
    public mutating func updateAnswer(_ answer: TaskQuestionAnswer) throws {
